...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom{
    ...
    // 2. 생성자에 매개변수로 EntityManager를 넣어서
    ...
    // Query DSL : 엔티티 클래스의 QDomian 의 객체를 생성
    //			-- 동적 쿼리를 적용할 수 있다. null이 반환이되면 처리하지 않고, null 아니면 처리하게된다.
    // QDomain 의 엔티티 클래스를 생성해야함.
