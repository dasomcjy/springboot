...
class SbbApplicationTests {
	...
	*/
	...
	@Transactional		// 아래의 메소드가 하나의 트랜잭션으로 작동되도록 설정 (Test 에서만 사용)
	@Test
	public void testjap8() {
		...
		// 2. 끄집어낸 객체의 q.getAnswerList();  <== 끄집어낸 객체 답변글을 얻어온다.
	...
	*/
	...
	public void testjpa4 () {
		...
		System.out.println("=========ASC 정료 후 출력============================");
	...
	*/
	...
	public void jpaTest() {
		...
		//assertEquals(10, all.size());	 // assertEquals( 기대값, 실제값 ) , 성공 (두값이 일치)
		
		Question q = all.get(0);  	// List all 변수에 담긴 0번방의 Question 객첼르 끄집어낸다.
